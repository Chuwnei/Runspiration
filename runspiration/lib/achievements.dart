        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: _singleton.borderColors[id], shape: BoxShape.circle),
            ),
            (type == "unlocked")
                ? ElevatedButton(
                    onPressed: () {
                        ...
                        onPressed: () {
                          if (int.parse(description) <=
                            ...
                            FirebaseFirestore.instance
                                ...
                                .update({
                              "currency":
                                  FieldValue.increment(-int.parse(description)),
                              "borders.active": id,
                              "borders.unlocked": FieldValue.arrayUnion([id])
                            }).then((value) => _singleton.setCurrentBorder(id));
                          } else {
